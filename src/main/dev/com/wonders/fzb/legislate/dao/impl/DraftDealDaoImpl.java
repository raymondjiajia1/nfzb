...
@Repository("draftDealDao")
public class DraftDealDaoImpl extends BaseSupportDao implements DraftDealDao{
	@Override
	public void save(Object object) {
		DraftDeal info = (DraftDeal) object;
		super.save(info);
	}
	...
	public Page findByPage(Map<String, Object> condMap, Map<String, String> sortMap, int pageNo, int pageSize) throws FzbDaoException  {
		...
		return super.findByPage(condMap, sortMap, pageNo, pageSize,"DraftDeal");
	}
	...
	public List<DraftDeal> findByList(Map<String, Object> condMap, Map<String, String> sortMap) {
		if (sortMap == null)
			sortMap = new LinkedHashMap<String, String>();
		sortMap.put("createTime", CommonConst.ORDER_DESC);
		return super.findByList(condMap, sortMap, "DraftDeal");
	}
