...
public class OpinionDaoImpl extends BaseSupportDao implements OpinionDao{
	@Override
	public void save(Object object) {
		Opinion info = (Opinion) object;
		super.save(info);
	}
	...
	public Page findByPage(Map<String, Object> condMap, Map<String, String> sortMap, int pageNo, int pageSize) throws FzbDaoException  {
		...
		return super.findByPage(condMap, sortMap, pageNo, pageSize,"Opinion");
	}
	...
	public List<Opinion> findByList(Map<String, Object> condMap, Map<String, String> sortMap) {
		if (sortMap == null)
			sortMap = new LinkedHashMap<String, String>();
		sortMap.put("createTime", CommonConst.ORDER_DESC);
		return super.findByList(condMap, sortMap, "Opinion");
	}
