...
@Transactional
public class PlanSummaryImpl implements PlanSummaryService{
	@Autowired
	PlanSummaryDao planSummary;
	...
	public PlanSummary findById(String id) {
		return (PlanSummary) planSummary.load(id);
	}
	...
	public Page findByPage(Map<String, Object> condMap, Map<String, String> sortMap, int pageNo, int pageSize) throws FzbDaoException {
		return planSummary.findByPage(condMap, sortMap, pageNo, pageSize);
	}
	...
	public List<PlanSummary> findByList(Map<String, Object> condMap, Map<String, String> sortMap) {
		return planSummary.findByList(condMap, sortMap);
	}

	@Override
	public void saveOrUpdate(PlanSummary info) {
		planSummary.saveOrUpdate(info);
	}
