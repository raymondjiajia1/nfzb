...
public class StringKit {
	...
	public static void main(String args[]) {
		// System.out.println(AESEncode("hjxx", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("xxzy", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("aqsckx", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("kfdxsj", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("gsxxxx", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("cjzyxxja", "fzb_user_execlaw_user"));
		// System.out.println(AESEncode("sjqzsjd", "fzb_user_execlaw_user"));
		System.out.println(AESEncode("spdxqjyj", "fzb_user_execlaw_user"));
		System.out.println(AESEncode("ssjqzbb", "fzb_user_execlaw_user"));
		System.out.println(AESEncode("sjsgjbmj", "fzb_user_execlaw_user"));
		
		
		// System.out.println(AESEncode("Abcde_12345", "fzb_user_admin"));
