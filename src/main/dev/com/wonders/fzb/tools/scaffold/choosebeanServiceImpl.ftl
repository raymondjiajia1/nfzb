...
public class ${table.tableTransName}ServiceImpl implements ${table.tableTransName}Service {
	 ...
	 */
	@Override
	public String addObj(${table.tableTransName} info) {
		return ${table.tableTransNameLow}Dao.saveObj(info);
	}
	...
	public List<${table.tableTransName}> findByHQL(String hql) {
		List<${table.tableTransName}> ${table.tableTransNameLow}List = ${table.tableTransNameLow}Dao.findByHQL(hql);
		return ${table.tableTransNameLow}List;
	}
}
