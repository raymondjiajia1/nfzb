...
<body>
	<div class="login2Box-container">
		<div class="wrap">
			<div class="loginText">
				<img src="./img/bg-header-text2.png" alt="">
			</div>
			<div class="loginBox">
				...
				<div class="login-form">
					<form id="form1" name="form1" action="login.do" method="post">
						<div class="login-form-control">
							...
							<!-- <input type="text" name="account" id="account" value="gaoj" placeholder="请输入用户名"> -->
						</div>
						<div class="login-form-control">
						...
						<div class="login-form-control vCode">
							<input type="text" id="codeId" name="codeId" placeholder="请输入验证码"> <img id="imgObj" src="../verifyCodeServlet" alt="" class="vCode" onclick="changeImg()">
							<!-- <img src="./img/img-login2-code.png" alt=""> -->
						</div>
	...
	<script>
		$(function() {//垂直居中
			...
			$(".login2Box-container .wrap").css({
				'margin' : (_wh - 550) / 2 + "px auto"
			});
			...
			// 登陆表单toggle
			$(".login2Box-container").on("click", ".loginBox-title h2",function() {	$(".login-form").slideToggle();	});
