							...
							<ul class="nav nav-second-level">
								<c:choose>
									<c:when test="${task.stNodeId=='NOD_0000000102'}">
										<li><a class="J_menuItem" href="../legislationProcessTask/legislationProcessTask_list.do?stNodeId=${task.stNodeId}">规章草案分办列表</a></li>
									</c:when>
									<c:when test="${task.stNodeId=='NOD_0000000101'}">
										<li><a class="J_menuItem" href="../legislationProcessTask/legislationProcessTask_list.do?stNodeId=${task.stNodeId}">规章草案起草列表</a></li>
									</c:when>
									<c:otherwise>
