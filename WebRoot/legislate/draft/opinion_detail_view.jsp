            ...
            <div class="clearfix">
                    ...
                    <div class="row rh">
                    	...
                    	<span class="formdiv">
                            <select name = "source" id = "source">
                                <option value = "电子邮件" <s:if test='opinionDetail.source == "电子邮件"'>selected="selected"</s:if>>电子邮件</option>
                                <option value = "网上民意" <s:if test='opinionDetail.source == "网上民意"'>selected="selected"</s:if>>网上民意</option>
                                <option value = "信函" <s:if test='opinionDetail.source == "信函"'>selected="selected"</s:if>>信函</option>
                                <option value = "电话" <s:if test='opinionDetail.source == "电话"'>selected="selected"</s:if>>电话</option>
                            </select>
                        </span>
                    </div>
                    <div class="row rh">
                        ...
                        <span class="formdiv">
                                <input type = "text" name="name" id="name" value="${opinionDetail.name }">
                        </span>
                    </div>
                    <div class="row rh">
                        <label class="formlabel">电话:</label>
                        <span class="formdiv">
                                <input type = "text" name="phone" id="phone" value="${opinionDetail.phone }">
                            </span>
                    </div>
                    <div class="row rh">
                        <label class="formlabel">意见内容:</label>
                        <span class="formdiv arh" style="width: 81%">
                                <textarea name = "content" id = "content">${opinionDetail.content }</textarea>
                            </span>
                    </div>
                    <div class="row rh">
                ...
                <div class="clearfix">
    			 ...
    			 <s:hidden name="draftId"/>
    			  <input type="hidden" name="outId" value="${opinionDetail.outId }"/>
    			  <s:hidden name="detailId"></s:hidden>
            </form>
    </div>
</div>
</div>
