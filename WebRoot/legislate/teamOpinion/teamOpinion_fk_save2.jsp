		    ...
		    <div class="container-fluid container-top">
		        <div class="row rh">
		            ...
		            <s:if test="op=='fk'">
		                ...
		                <a href="${basePath}/legislate/detaillist.do?teamOpinionId=<s:property value="teamOpinionId"/>" class = "sui-btn btn-primary01 btn-lg btn-170 layer-close">关闭</a>
		            </div>
		        </div>
		    </div>
		</div>
...
<script> 
 	...
 	function uploadDraftFile(){
		document.draftForm.action = '${basePath}/legislate/teamOpinion_fk_uploadFile.do?st=jsqk&teamOpinionId=${teamOpinionId}';
		alert("反馈成功");
