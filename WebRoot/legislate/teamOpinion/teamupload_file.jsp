...
<div class = "conteng">
    ...
    <div class = "conteng-title">
 	...
 	<form method="post" enctype="multipart/form-data" action="${basePath}/legislate/uploadDraftFile.do" name="draftForm">
                    ...
                    <div class="row rh">
                        ...
                        <span class="formdiv">
                            ...
                            点击选择材料
                             ...
                             <input type="hidden" id="op" value="0" name="saveDraft">
                             <input type="hidden" id="op" value="${param.draftId }" name="draftId">
                          </a>
                            <p class="file-text">
                            未选择文件
                           </p>
