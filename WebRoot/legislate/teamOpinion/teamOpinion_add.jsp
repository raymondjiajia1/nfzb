...
<%--                                     <s:select label="对应草案" name = "draftId" id = "draftId"  list="#request.draftList" value="draftId" listValue="draftName" listKey="draftId" ></s:select> --%>
                                ...
                                <tr>
                                	<th>类型:</th>
                                	<td>
                                		<select name="opinionType" >
                                		<option value="征询">征询</option>
                                		<option value="征询含会签">征询含会签</option>
                                	</select>
                                	</td>
<%-- 			                         <s:select label="类型" list="#{'征询':'征询','征询含会签':'征询含会签'}" name="opinionType"  value="teamOpinion.opinionType" cssClass="input-xlarge"></s:select> --%>
                                </tr>
                                <tr>
                                	<th>渠道:</th>
                                	<td>
                                		<select name="opinionChannel" >
                                		<option value="内部">内部</option>
                                		<option value="外部">外部</option>
                                	</select>
                                	</td>
<%-- 			                         <s:select label="渠道" list="#{'内部':'内部','外部':'外部'}" name="opinionChannel"  value="teamOpinion.opinionChannel" cssClass="input-xlarge"></s:select> --%>
                                </tr>
                                <tr>
                                    <th>表单:</th>
                                    <td> <a  onclick="openFbdDoc();" class = "sui-btn btn-primary01 btn-lg btn-170">编辑</a></td>
                ...
                <div class="clearfix">
                    <div class="container-fluid container-top">
                        <div class="row rh">
                            <div class="col-sm-12 text-center">
                                 <button type="button" onclick="add('${draftId}');" class="btn btn-info btn-bg btn-120">提交</button>
               	 ...
               	 <%if(request.getParameter("teamOpinionId") != null){ %>
			           ...
			           <table class = " table-height">
                                ...
                                <caption  style="font-weight:bold;color:#000">其他材料 <input class="chakan caozuo-btn btn-70" type="button" value="点击上传" onclick="uploadFile('需要报送的其他材料');"></caption>
				                <tbody>
				                <s:iterator value="modellist" var="model">
				                	<% 
					               		Model model = (Model)request.getAttribute("model");
