...
<div style = "border-bottom: 2px solid #B9404D; height: 270px;">
    ...
    <div class = "container-fluid container-top">
        <div class = "row">
            ...
            <div class = "col-sm-2 " style = "float: left">
                <span class = "szgb"><s:textfield name="teamName" disabled="true" value="%{planTask.plan.teamName}"/></span>
            </div>
            <div class = "col-sm-1"></div>
            <div class = "col-sm-4 col-sm-offset-3" style = "float: right;">
                <span class = "text-color">日期:</span>
                <span class = "bdbt"><s:date name="planTask.plan.createTime" format="yyyy"/></span>
                <span class = "text-color">年</span>
                <span class = "bdbt"><s:date name="planTask.plan.createTime" format="MM"/></span>
                <span class = "text-color">月</span>
                <span class = "bdbt"><s:date name="planTask.plan.createTime" format="dd"/></span>
        ...
        <div class = "row">
            ...
            <div class = "col-sm-8">
                <p class = "wjmc" style = "display: inline-block;">
                    <s:textfield disabled="true" name="planName" value="%{planTask.plan.planName}"/>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class = "container-fluid bdtop">
        <div class = "row">
            ...
            <div class = "col-sm-8">
                 <s:textarea name="instructions" id="instructions" cssClass="fenban-textarea" style="display:inline-block;width: 420px;float: left;"></s:textarea>
            </div>
        </div>
    </div>
    <div class = "clearfix"></div>
    <div class = "container-fluid container-top">
        <div class = "row">
            ...
            <div class = "col-sm-3" style = "display: inline-block;">
                <span class = "bdbt"><input name="year" id="year" style="width:40px"/></span>
                <span class = "text-color" style="padding-left:8px;">年</span>
...
<div class = "submit-btn">
    <a  onclick="saveFBD('${planTask.plan.planId}')" class = "sui-btn btn-primary01 btn-lg btn-170">确认分办</a>
...
<script>
	...
	function saveFBD(planId){
      	 	...
      	 	$.ajax({
     	 		"type":"POST",
     	 		"dataType":"json",
     	 		"url":"${basePath}/legislate/plan_dise.do",
     	 		"data":{'fbdId':'${planTask.plan.fbd.fbdId }',"teamId":$('#pteamId').val(),"planId":planId,"op":"doDise","year":$('#year').val(),"month":$('#month').val(),"day":$('#day').val(),"instructions":$('#instructions').val(),"taskId":"${taskId}"},
